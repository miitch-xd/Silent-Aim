...
def print_banner(bot: triggerBot) -> None:
    ...
    print("Trigger Bot       :", (Fore.GREEN if bot.toggled else Fore.RED) + ("Açık" if bot.toggled else "Kapalı") + Style.RESET_ALL)
    print("Bunny-Hop         :", (Fore.GREEN if bot._bunny else Fore.RED) + ("Açık" if bot._bunny else "Kapalı") + Style.RESET_ALL)
